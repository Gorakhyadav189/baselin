...
<?php include('header.php'); ?>
    ...
    <?php include('sidebar.php'); ?>
        ...
        <div class="main">
        <h2>Add Product</h2>
            <form method="post" id="add-product" action="" enctype="multipart/form-data">
                ...
                <input type="text" name="des" id="description">
        ...
        $(document).ready(function() {
            ...
            $("#submit-products").click(function() {
                ...
                if (pname == "") {
                    ...
                    $(".pnameerror").html("");
                    $(".descerror").html("please enter the description");
                } else if (stock == "") {
                    $(".pnameerror").html("");
                    $(".descerror").html("");
                    $(".stockerror").html("plese fil stock");
                    ...
                    $(".descerror").html("");
                    $(".stockerror").html("");
                    $(".sqrerror").html("plese fill sqr box");
                    ...
                    $(".stockerror").html("");
                    $(".sqrerror").html("");
                    $(".priceerror").html("plese enter the price of product");
                    ...
                    let myform = document.getElementById("add-product");
                    let fd = new FormData(myform);
                    $.ajax({
                        url: "add-product-backend.php",
                        data: fd,
                        cache: false,
                        processData: false,
                        contentType: false,
